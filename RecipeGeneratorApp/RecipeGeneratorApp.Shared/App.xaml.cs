...
using RecipeGeneratorApp.Common;
...
namespace RecipeGeneratorApp
{
    ...
    public sealed partial class App : Application
    {
...
#endif
        public static SQLiteAsyncConnection conn = new SQLiteAsyncConnection("RecipeGeneratorApp.db");
        /// <summary>
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            this.dbPath = Path.Combine(Windows.Storage.ApplicationData.Current.LocalFolder.Path, "RecipeGeneratorApp.db");
            using (var dbase = new SQLite.SQLiteConnection(dbPath))
            {
                dbase.CreateTable<Member>();
                dbase.CreateTable<Likes>();
            }
